...
//    @ValueSource(doubles = {89.0, 95.0, 100.0})
//    @CsvSource(value = {"89.0, 1.72", "95.0, 1.75", "110.0, 1.78"})
        ...
        void should_return_true_When_Diet_Recommended(Double coderWeight, Double coderHeight) {
            ...
            //when
            final boolean dietRecommended = BMICalculator.isDietRecommended(weight, height);
        ...
        @Test
        void should_return_true_When_Diet_NotRecommended() {
            //given
            double weight = 68.0;
            double height = 1.65;
        ...
        @Test
        void should_Throw_Arifmetic_Exeption_When_Height_Zero() {
            //given
            double weight = 68.0;
            double height = 0.00;
...
//        @Disabled
        ...
        @Test
        void shouldReturnCoderWithWorstBMIIn1Ms_When_CoderListHas10000Elements() {
            ...
            //then
            assertTimeout(Duration.ofMillis(18), executable);
        }
